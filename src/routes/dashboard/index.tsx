  ...
  return (
    <Stack gap="xl">
        ...
        {stats.map((stat) => (
          ...
          >
            ...
            <Group align="flex-end" gap="xs" mt={20}>
              <Text fw={800} fz={32} c="dark.8" style={{ lineHeight: 1 }}>
                {stat.value}
              </Text>
              {stat.diff && (
      ...
      >
        ...
        <Text c="dimmed" mb="xl">
          Te sugerimos estas acciones para mejorar tu catálogo y atraer más
          ventas.
        </Text>
        ...
        <Stack gap="sm">
          {[
            ...
            {
              label: "Comparte el enlace de tu catálogo por WhatsApp",
              done: false,
            },
